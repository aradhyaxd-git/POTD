...
pj is the new position of the jth element. If i < j and both elements are smaller (or larger)
...
class Solution {
    public int[] pivotArray(int[] nums, int pivot) {
      ...
      int i = 0, // less than pivot
          j = lessThanPivot, // equal to pivot
          k = lessThanPivot + equalToPivot; // greater than pivot
      int n = nums.length;
